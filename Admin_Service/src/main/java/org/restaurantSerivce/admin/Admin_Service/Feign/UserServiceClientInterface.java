...
public interface UserServiceClientInterface {
    ...
    @GetMapping(value = "/api/users/internal/{userid}")
    ResponseEntity<InternalUserResponseDTO> getUserForInternal(@PathVariable("userid") String userId, @RequestHeader("Authorization") String authorizationHeader);
